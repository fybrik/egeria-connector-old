...
*/}}
{{- define "egeriaConnector.fullname" -}}
...
Common labels
*/}}
{{- define "egeriaConnector.labels" -}}
helm.sh/chart: {{ include "egeriaConnector.chart" . }}
{{ include "egeriaConnector.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "egeriaConnector.selectorLabels" -}}
app.kubernetes.io/name: {{ include "egeriaConnector.name" . }}
...
*/}}
{{- define "egeriaConnector.image" -}}
{{- $root := first . -}}
{{- $ctx := last . -}}
{{- if contains "/" $ctx.image }}
{{- printf "%s" $ctx.image }}
{{- else }}
{{- printf "%s/%s:%s" ( $ctx.hub | default $root.Values.hub ) $ctx.image ( $ctx.tag | default $root.Values.tag | default $root.Chart.AppVersion ) }}
{{- end }}
{{- end }}
...
*/}}
{{- define "egeriaConnector.isEnabled" -}}
{{- $flag := toString (first .) -}}
{{- $condition := last . -}}
...
*/}}
{{- define "egeriaConnector.isRazeeEnabled" -}}
...
*/}}
{{- define "egeriaConnector.certManagerApiVersion" -}}
...
*/}}
{{- define "egeriaConnector.getBlueprintNamespace" -}}
{{- if .Values.blueprintNamespace -}}
{{- .Values.blueprintNamespace -}}
{{- else -}}
{{- "egeriaConnector-blueprints" -}}
{{- end -}}
{{- end -}}
